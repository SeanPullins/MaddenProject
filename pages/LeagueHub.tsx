    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-400 text-lg">
          Join multiplayer leagues. Manage your franchises and compete with other GMs.
        </p>
      </div>
      ...
      <div className="mb-8">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-brand-500 hover:bg-brand-600 text-white font-bold rounded-lg transition-colors"
        >
          <LogIn size={24} />
        ...
        {leagues.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-slate-500 text-sm">
              Join a league with an invite code to get started
            </p>
          </div>
        ) : (
